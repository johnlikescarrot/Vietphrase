const DOMElements = {
  ...
  qSplitBtn: document.getElementById('q-split-btn'),
  ...
  qVietphraseToggleBtn: document.getElementById('q-vietphrase-toggle-btn'),
  qVietphraseOptionsContainer: document.getElementById('q-vietphrase-options-container'),
